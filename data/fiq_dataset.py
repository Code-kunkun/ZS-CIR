...
class FashionIQDataset(Dataset):
    ...
    def __init__(self, split: str, dress_types: List[str], mode: str, preprocess: callable):
        ...
        for dress_type in dress_types:
            with open(f'/GPFS/data/yikunliu/Fashion-IQ/fashion-iq/captions/cap.{dress_type}.{split}.json') as f:
                self.triplets.extend(json.load(f))

        # get the image names
        self.image_names: list = []
        for dress_type in dress_types:
            with open(f'/GPFS/data/yikunliu/Fashion-IQ/fashion-iq/image_splits/split.{dress_type}.{split}.json') as f:
    ...
    def __getitem__(self, index):
        try:
            if self.mode == 'relative':
                ...
                if self.split == 'train':
                    reference_image_path = f'/GPFS/data/yikunliu/Fashion-IQ/fashion-iq/images/{reference_name}.png'
                    reference_image = self.preprocess(PIL.Image.open(reference_image_path))
                    target_name = self.triplets[index]['target']
                    target_image_path = f'/GPFS/data/yikunliu/Fashion-IQ/fashion-iq/images/{target_name}.png'
                ...
                image_path = f'/GPFS/data/yikunliu/Fashion-IQ/fashion-iq/images/{image_name}.png'
